...
import com.example.zhiyeaiagent.agent.model.AgentState;
import lombok.Data;
...
/**
 * 处理工具调用的基础代理，具有增强的抽象(实现了think和act方法,可以用作创建实例的父类)
 */
...
public class ToolCallAgent extends ReActAgent {
    ...
    public ToolCallAgent(ToolCallback[] availableTools) {
        ...
        //使用阿里云ai，spring ai的自动工具调用不兼容，无法工具调用，就用阿里自己的ChatOptions
...
//            log.info(toolCallInfo);
    ...
    public String act() {
        ...
        //判断是否调用终止工具
        boolean terminateDid = toolResponseMessage.getResponses().stream()
