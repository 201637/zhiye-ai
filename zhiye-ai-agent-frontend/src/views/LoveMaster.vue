...
// 设置页面标题和元数据
useHead({
  title: 'AI职业大师 - AI超级智能体应用平台',
  meta: [
    {
      name: 'description',
      content: 'AI职业大师是AI超级智能体应用平台的专业顾问，帮你解答各种职业问题，提供面试建议'
    },
    {
      name: 'keywords',
      content: 'AI职业大师,职业咨询,AI聊天,面试问题,AI智能体'
    }
  ]
})
...
const generateChatId = () => {
  return 'zhiye_' + Math.random().toString(36).substring(2, 10)
}
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI职业大师，请告诉我你的学历、专业，想要找的工作地点、薪资等信息，我会尽力给予帮助和建议。', false)
})
