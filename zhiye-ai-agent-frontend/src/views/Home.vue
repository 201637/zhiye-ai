  ...
  <div class="home-container">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI职业领域大师</div>
          <div class="app-desc">智能职业顾问，帮你解答职业烦恼</div>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI超级智能体应用平台提供AI职业大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI职业大师,AI助手,智能对话,AI超级智能体,首页'
    }
  ]
})
